...
const Navbar = memo((props) => {
    ...
    return (
        <>
                        ...
                        <Col md={6} className="d-flex justify-content-center align-items-center">
                            ...
                            <div className="mx-4">
                                <Link to={routes.PUBLISHER} replace={true}>
                                    <p className={`m-0 fs-xs-static en-font-default hover-underline-animation ${i18n.language === locales.AR ? "ar-font-bold" : "en-font-bold"} ${color === colors.black ? "underline-black" : "underline-white"}`} style={{ color: color }}>{t("publisher")}</p>
            ...
            <Container fluid className={`nav-padding py-3 d-block d-lg-none ${scroll && "sticky bg-white transition"}`} style={{ position: !scroll && 'absolute', top: isLoggedIn ? '78px' : 0, left: 0, right: 0, zIndex: 99 }}>
            ...
            <Drawer
                style={{ width: "100%", height: "100%", scrollBehavior: "smooth", minHeight: "100%", zIndex: 1050, backgroundColor: colors.white }}
                open={isOpen}
                direction='right'
                className="p-3"
